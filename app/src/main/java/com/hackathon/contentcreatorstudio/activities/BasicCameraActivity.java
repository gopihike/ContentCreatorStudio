...
import static com.hackathon.contentcreatorstudio.utils.CameraUtils.MEDIA_TYPE_VIDEO;
...
public class BasicCameraActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = BasicCameraActivity.class.getSimpleName();
